...
call <SID>AddAlternateExtensionMapping('h',"c,cpp,cu,cxx,cc,CC")
call <SID>AddAlternateExtensionMapping('H',"C,CPP,cu,CXX,CC")
call <SID>AddAlternateExtensionMapping('hpp',"cpp,c")
call <SID>AddAlternateExtensionMapping('HPP',"CPP,C")
call <SID>AddAlternateExtensionMapping('c',"h")
call <SID>AddAlternateExtensionMapping('C',"H")
call <SID>AddAlternateExtensionMapping('cu',"h,hpp")
